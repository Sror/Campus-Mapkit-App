...
- (void)viewDidLoad
{
    ...
    self.NewtonMapView.delegate = self;
    
    
    
    [NewtonMapView setMapType:MKMapTypeHybrid];
    [NewtonMapView setZoomEnabled:YES];
    [NewtonMapView setScrollEnabled:YES];
    ...
    [NewtonMapView setRegion:region animated:YES]; 
    
    [NewtonMapView setDelegate:self];
    ...
    [NewtonMapView addAnnotation:ann];
    ...
    [NewtonMapView addAnnotation:ann1];
    ...
    [NewtonMapView addAnnotation:ann2];
    ...
    [NewtonMapView addAnnotation:ann4];
    ...
    [NewtonMapView addAnnotation:ann5];
    ...
    [NewtonMapView addAnnotation:ann6];
    ...
    [NewtonMapView addAnnotation:ann7];
    ...
    [NewtonMapView addAnnotation:ann8];
    ...
    [NewtonMapView addAnnotation:ann9];
    ...
    [NewtonMapView addAnnotation:ann10];
    ...
    [NewtonMapView addAnnotation:ann11];
    ...
    [NewtonMapView addAnnotation:ann12];
    ...
    [NewtonMapView addAnnotation:ann13];
    ...
    [NewtonMapView addAnnotation:ann14];
...
- (MKAnnotationView *)mapView:(MKMapView *)mv viewForAnnotation:(id <MKAnnotation>)annotation{static NSString *parkingAnnotationIdentifier=@"ParkingAnnotationIdentifier";
    ...
    if([annotation isKindOfClass:[MKAnnotationView class]]){
        ...
        MKAnnotationView *annotationView=[NewtonMapView dequeueReusableAnnotationViewWithIdentifier:parkingAnnotationIdentifier];
