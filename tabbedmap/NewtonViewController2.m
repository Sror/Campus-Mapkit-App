...
#import "NewtonViewController2.h"
#import "DisplayMap.h"
#import "EventViewController.h"


@implementation NewtonViewController2
@synthesize NewtonMapView2;
...
- (void)viewDidLoad
{
    ...
    self.NewtonMapView2.delegate = self;
    
    [NewtonMapView2 setMapType:MKMapTypeHybrid];
    [NewtonMapView2 setZoomEnabled:YES];
    [NewtonMapView2 setScrollEnabled:YES];
    ...
    [NewtonMapView2 setRegion:region animated:YES]; 
    
    [NewtonMapView2 setDelegate:self];
    ...
    [NewtonMapView2 addAnnotation:ann];
    ...
    [NewtonMapView2 addAnnotation:ann1];
    ...
    [NewtonMapView2 addAnnotation:ann2];
    ...
    [NewtonMapView2 addAnnotation:ann4];
    ...
    [NewtonMapView2 addAnnotation:ann5];
    ...
    [NewtonMapView2 addAnnotation:ann6];
    ...
    [NewtonMapView2 addAnnotation:ann7];
    ...
    [NewtonMapView2 addAnnotation:ann8];
    ...
    [NewtonMapView2 addAnnotation:ann9];
    ...
    [NewtonMapView2 addAnnotation:ann10];
    ...
    [NewtonMapView2 addAnnotation:ann11];
    ...
    [NewtonMapView2 addAnnotation:ann12];
    ...
    [NewtonMapView2 addAnnotation:ann13];
    ...
    [NewtonMapView2 addAnnotation:ann14];
...
- (MKAnnotationView *)mapView:(MKMapView *)mv viewForAnnotation:(id <MKAnnotation>)annotation{static NSString *parkingAnnotationIdentifier=@"ParkingAnnotationIdentifier";
    ...
    if([annotation isKindOfClass:[MKAnnotationView class]]){
        ...
        MKAnnotationView *annotationView=[NewtonMapView2 dequeueReusableAnnotationViewWithIdentifier:parkingAnnotationIdentifier];
